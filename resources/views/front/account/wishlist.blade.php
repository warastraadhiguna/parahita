                                ...
                                <div class="d-block d-sm-flex align-items-start text-center text-sm-start">
                                    ...
                                    <div class="pt-2">
                                        ...
                                        <div class="fs-lg text-accent pt-2">
                                            <span class="h5"><strong>Rp.{{ NumberFormat($wishlist->product->price) }}</strong></span>
                                            @if ($wishlist->product->compare_price > 0)
                                            <span class="h6 text-underline"><del>Rp.{{ NumberFormat($wishlist->product->compare_price) }}</del></span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
